...
const IVs = () => (
	<div className={section}>
		...
		<p>
			Because the Destiny Knot will pass at most 5 IVs to a child, it&apos;s commonplace to choose one state per pokémon to let generate randomly. Frequently, this is done while min-maxing for that pokémon&apos;s intended role. A <img alt="" src={barraskewda} /> Barraswekda who will only ever be taught physical moves doesn&apos;t really care about having a perfect Special Attack stat.
		</p>
		<p>
